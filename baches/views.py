# =============================================================================
# A. CONFIGURACIÓN E IMPORTACIONES ⚙️
# =============================================================================
# Propósito: Este bloque contiene las importaciones (que ya tienes al inicio
# de tu archivo) y cualquier variable de configuración global que necesites.
...
from .forms import BacheForm, RegistroForm, PasswordResetRequestForm, PasswordResetConfirmForm, UserUpdateForm, PerfilUpdateForm
from .decorators import solo_municipio



# =============================================================================
# B. FUNCIONES AUXILIARES DE BAJO NIVEL (UTILITIES) 🛠️
# =============================================================================
# Propósito: Funciones pequeñas que realizan tareas repetitivas, como
# generación de códigos, o que son internas (empiezan con `_`).
...
# =============================================================================
# C. LÓGICA DE AUTENTICACIÓN Y SEGURIDAD (AUTH) 🔐
# =============================================================================
# Propósito: Vistas y clases que manejan el acceso, registro y gestión de
# credenciales (login, logout, registro, reseteo de contraseña).
...
def editar_perfil(request):
    perfil, _ = Perfil.objects.get_or_create(user=request.user, defaults={"rol": "vecino"})
    if request.method == "POST":
        uform = UserUpdateForm(request.POST, instance=request.user)
        pform = PerfilUpdateForm(request.POST, instance=perfil)
        ...
        pform = PerfilUpdateForm(instance=perfil)
    return render(request, "baches/editar_perfil.html", {
        "uform": uform,
        "pform": pform,
    })

# SI ESTA LOG, QUE VAYA A LANDING
def landing(request):
    # Si ya está logueado, que el botón diga "Ir al sistema"
    return render(request, "landing.html")



# =============================================================================
# D. RECLAMOS: VISTAS DEL VECINO (CORE) 💡
# =============================================================================
# Propósito: Funciones principales accesibles por cualquier usuario (vecino)
# para ver, crear y interactuar con los baches/pozos.
...
# =============================================================================
# E. FUNCIONES DE NOTIFICACIÓN Y MENSAJERÍA 🔔
# =============================================================================
# Propósito: Lógica para mostrar y gestionar las notificaciones al usuario.
...
# =============================================================================
# F. PANEL DE GESTIÓN MUNICIPAL (ADMIN) 🏢
# =============================================================================
# Propósito: Funciones exclusivas para el rol 'municipio' para la
# administración y el dashboard.
...
# =============================================================================
# G. FUNCIONES DE REPORTES Y EXPORTACIÓN 📊
# =============================================================================
# Propósito: Vistas para generar archivos de salida (CSV, Excel, PDF).
# Estas funciones consumen el output de `_get_baches_filtrados_para_export`.
